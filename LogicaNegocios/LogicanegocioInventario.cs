...
namespace LogicaNegocios
{
    public class LogicanegocioInventario
    {
        ...
        private AccesoKika operacion = null;
        public LogicanegocioInventario(string cadconexion)
        {
            operacion = new AccesoKika(cadconexion);
        }
        ...
        public Boolean Insertaractualizacion(string numero_serie, string descripcion, DateTime fecha, string num_inv, ref string m)
        {
            ...
            operacion.ModificarBDMasseguro(sentencia, operacion.AbrirconexionSQL(ref m), ref m, coleccion);
            return salida;
        }
        ...
        public Boolean Insertartiporam(int id_TipoRAM, string Tipo, string Extra, ref string m)
        {
        ...
        public DataTable obtenactualizaciones(ref string mensaje)
        {
            ...
            obtener = operacion.ConsultaDataSet(consulta, operacion.AbrirconexionSQL(ref mensaje), ref mensaje);
