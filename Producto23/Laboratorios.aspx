<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laboratorios.aspx.cs" Inherits="Producto23.Laboratoriossaspx" %>
        ...
        <div>
            ...
            <center>
                <p>
                    &nbsp;</p>
                <p>
                    <asp:Label ID="Label1" runat="server" Font-Names="Cascadia Code SemiBold" Font-Size="XX-Large" ForeColor="#9900CC" Text="Laboratorios"></asp:Label>
                </p>
                <p>
                ...
                <p>
                    <asp:Label ID="Label3" runat="server" Font-Names="Cascadia Code SemiBold" ForeColor="#9966FF" Text="Nombre de laboratorio: " Font-Size="Large"></asp:Label>
&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox3" runat="server" Height="31px" Width="180px"></asp:TextBox>
                </p>
                <p>
                    <asp:Label ID="Label4" runat="server" Font-Names="Cascadia Code SemiBold" ForeColor="#9966FF" Text="Ubicacion: " Font-Size="Large"></asp:Label>
                    &nbsp;&nbsp;
                    <asp:TextBox ID="TextBox1" runat="server" Width="305px" Height="30px"></asp:TextBox>
                </p>
                <p>
&nbsp;</p>
                <p>
                ...
                <p>
                    <asp:TextBox ID="TextBox2" runat="server" Width="440px" Height="31px"></asp:TextBox>
                </p>
                <p>
